...
public class Test {
	...
	public static void main(String[] args) {
		...
		Product product = new Product(1, "Pagani", "Huayra", "Silver", "Car", "Medium", "Hypercar", tags1, 1.00, 999.99, (short) 2, imagePaths);
		SQL_Util.addProduct(product);
		ArrayList<Tag> tags2 = new ArrayList<Tag>();
		tags2.add(new Tag(2, "Track"));
		tags2.add(new Tag(2, "British"));
		product = new Product(1, "McLaren", "P1", "Orange", "Car", "Medium", "Hypercar", tags2, 1.00, 999.99, (short) 2, imagePaths);
		SQL_Util.addProduct(product);
